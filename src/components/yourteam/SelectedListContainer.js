...
render() {
    return (
      <div className='selected-list' >
        ...
        <PlayerPopup togglePopup={this.togglePopup} pickedPlayer={this.props.selectedPlayers.find(player => player.id === this.state.playerId)} unSelectPlayerButton={this.unSelectPlayerButton} /> 
        }
      </div>
    )
  }
